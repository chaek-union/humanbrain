...
그러나 세포 유형 정체성은 보존되더라도, 각 세포 유형의 상대적 비율(abundance)과 각 세포 유형 내에서의 유전자 발현 수준은 개인마다 상당히 달랐다. 이 개인 간 변이(interindividual variation)를 분석했을 때, 나이, 성별, 유전적 조상, 그리고 여러 기저 상태들이 일부를 설명했지만, 측정된 이 모든 변수들을 합쳐도 개인 간 변이의 소수만을 설명할 수 있었다. 가장 큰 변이는 그냥 "개인"이었다. 마치 같은 학교에서 같은 교육을 받아도 사람마다 서로 다른 성격과 능력을 갖게 되는 것처럼, 각 개인이 가진 고유한 유전적 배경과 생애 경험의 총합이 그 개인 고유의 뇌 세포 구성을 만들어낸다는 것이다. 흥미로운 것은 이 변이가 세포 유형에 따라 달랐다는 점이다. 심층 글루타메이트 뉴런(deep-layer glutamatergic neuron)과 미세아교세포(microglia)가 가장 큰 개인 간 변이를 보였다. 미세아교세포는 뇌의 면역세포로서, 외부 위협에 반응하고 죽은 세포를 청소하는 역할을 하는데, 이 세포가 높은 변이를 보인다는 것은 뇌의 면역 환경이 개인마다 상당히 다르다는 것을 시사하고, 이것은 개인마다 다른 뇌 관련 질환 감수성과 연관될 가능성이 있다.
