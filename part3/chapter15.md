...
Garcia et al. (2022)는 인간 뇌 혈관계를 단일 세포 수준에서 최초로 체계적으로 분석한 연구로, 16,681개의 핵에서 11개의 세포 하위 유형을 동정했다. 내피세포는 동맥(arteriole), 모세혈관(capillary), 정맥(venule)의 세 하위 유형으로 나뉘었다. 동맥 내피세포는 [VEGFC](https://www.genecards.org/cgi-bin/carddisp.pl?gene=VEGFC), [DKK2](https://www.genecards.org/cgi-bin/carddisp.pl?gene=DKK2), ARL15를, 모세혈관 내피세포는 [CLDN5](https://www.genecards.org/cgi-bin/carddisp.pl?gene=CLDN5), [SLC2A1](https://www.genecards.org/cgi-bin/carddisp.pl?gene=SLC2A1)(GLUT1), [ABCB1](https://www.genecards.org/cgi-bin/carddisp.pl?gene=ABCB1), ATP10A를, 정맥 내피세포는 [TSHZ2](https://www.genecards.org/cgi-bin/carddisp.pl?gene=TSHZ2), [ADGRG6](https://www.genecards.org/cgi-bin/carddisp.pl?gene=ADGRG6), [AFF3](https://www.genecards.org/cgi-bin/carddisp.pl?gene=AFF3), ACKR1을 마커로 가진다. 주위세포는 세 가지 하위 유형(Pericyte 1: [PDGFRB](https://www.genecards.org/cgi-bin/carddisp.pl?gene=PDGFRB), [ANO3](https://www.genecards.org/cgi-bin/carddisp.pl?gene=ANO3); Pericyte 2: [APPBP2](https://www.genecards.org/cgi-bin/carddisp.pl?gene=APPBP2), [PCSK7](https://www.genecards.org/cgi-bin/carddisp.pl?gene=PCSK7))으로, 혈관 평활근 세포는 동맥과 정맥 유형으로 나뉘었다. 주목할 만한 점은 인간과 마우스 사이의 혈관 세포에서 관찰되는 종 간 차이가 상당하다는 것이다. 내피세포에서 12배, 섬유모세포에서 14배, 주위세포에서 15배의 차별 발현 유전자가 인간과 마우스 사이에 존재한다. 마우스에서 검증된 뇌 혈관 생물학적 발견이 인간에서도 같은 방식으로 작동할 것이라는 가정은 신중해야 한다.
...
동맥 내피세포의 마커로는 Bmx, Efnb2, Vegfc, Sema3g가 있고, 모세혈관 내피세포에는 [MFSD2A](https://www.genecards.org/cgi-bin/carddisp.pl?gene=MFSD2A)(caveolae를 억제하여 낮은 소포 수송을 유지), SLC2A1(GLUT1, 포도당 수송), [SLC7A5](https://www.genecards.org/cgi-bin/carddisp.pl?gene=SLC7A5)(LAT1, 아미노산 수송), [TFRC](https://www.genecards.org/cgi-bin/carddisp.pl?gene=TFRC)(트랜스페린 수용체) 같은 수송 분자들이 집중되어 있다. 정맥 내피세포는 Nr2f2, Slc38a5, Ackr1을 발현하며 면역 세포의 혈관 외 이동(leukocyte trafficking)과 관련된 기능을 가진다. 이 연속체적 변화 패턴은 혈관을 단순히 '동맥/정맥/모세혈관'으로 구분하는 것이 아니라, 하나의 연속적인 분자 기울기(gradient)로 이해해야 한다는 것을 의미한다.
