...
이 장에서 살펴본 것처럼, 뇌 유전체 연구는 기술의 발전과 함께 볼 수 있는 것의 범위를 넓혀왔다. 마이크로어레이에서 RNA-seq로, 벌크 조직에서 단일 세포로, 그리고 사후 조직에서 살아있는 모델 시스템으로. 각각의 기술적 전환은 이전에 보이지 않던 뇌의 분자적 구조를 드러냈고, 동시에 새로운 질문을 던졌다. 다음 장에서는 이 여정의 첫 번째 이정표, 인간 뇌의 시공간 전사체를 처음으로 체계적으로 매핑한 연구로 들어간다.
